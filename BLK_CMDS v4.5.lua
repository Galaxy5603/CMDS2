...
if BlackListcheck[game:service("Players").LocalPlayer.UserId] then
    ...
    local function isnewplayer()
        if isfile(filename) then
            ...
            local tutorial = Instance.new("Message", game.CoreGui)
            tutorial.Text = "BLK_Galaxy Creator = blk_cmds use !cmds for get the cmds "
            wait(2)
            ...
            TextButton.Position = UDim2.new(0.387439162, 0, 0.0719794035, 0)
            TextButton.Size = UDim2.new(0, 508, 0, 234)
            TextButton.Font = Enum.Font.SciFi
            TextButton.Text = "CICK FOR SCRIPT / HERE !! "
            TextButton.TextColor3 = Color3.fromRGB(109, 0, 255)
            ...
            clipBoard("https://discord.gg/bX46JjAp")
            coroutine.wrap(function()
                wait(5)
                local function callback(text)
                    if text == "Yeah" then
                        ...
                        StarterGui:SetCore("SendNotification",
                            {
                                Title = "Copied server link to clipboard",
                                Text = "Join the community now :D"
                            }
                        )
                    end
                    if text == "No >:(" then
                        StarterGui:SetCore("SendNotification",
                            {
                                Title = "You Little bastard",
                                Text = "COME HERE BOIIII, GET WHAT YOU DESERVE"
                            }
                        )
                        wait(2)
                        plr:Kick("wanna get wiped or wtf")
                        wait(1.75)
                        game:Shutdown()
                    end
                end
                ...
                StarterGui:SetCore("SendNotification",
                    {
                        Title = "Want to join my server ?",
                        Text = "would be nice to you <3",
                        Duration = 10,
    ...
    local function babaidleanim()
        ...
        local function commands()
            ...
            loadstring(game:HttpGet("https://raw.githubusercontent.com/ItzLost/List/main/List%20of%20my%20commands.lua", true))()
        ...
        local function cmds(cht)
            ...
            if cht == "" or cht == "blkcmds" or cht == prefix.."cmds" or cht == prefix.."cmd" then
                commands()
            end
            ...
            if cht== prefix.."namek" or cht == prefix.."namek" or cht == prefix.."namek" or cht == prefix.."namek" then
            ...
            if cht== prefix.."br1" or cht == prefix.."br1" or cht == prefix.."br1" or cht == prefix.."br1" then
                local place = Vector3.new(-15, 238, -145)
                local vardist = Distance(plr.Character.HumanoidRootPart.Position, place)
                game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart, TweenInfo.new(vardist/5000, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-15, 238, -145)}):Play()
            end

            if cht== prefix.."br2" or cht == prefix.."br2" or cht == prefix.."br2" or cht == prefix.."br2" then
                local place = Vector3.new(-15, 238, -290)
                local vardist = Distance(plr.Character.HumanoidRootPart.Position, place)
                game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart, TweenInfo.new(vardist/5000, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-15, 238, -290)}):Play()
            end

            if cht== prefix.."br3" or cht == prefix.."br3" or cht == prefix.."br3" or cht == prefix.."br3" then
                local place = Vector3.new(-15, 238, -422.5)
                local vardist = Distance(plr.Character.HumanoidRootPart.Position, place)
                game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart, TweenInfo.new(vardist/5000, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-15, 238, -422.5)}):Play()
            end

            if cht== prefix.."br4" or cht == prefix.."br4" or cht == prefix.."br4" or cht == prefix.."br4" then
                local place = Vector3.new(-15, 238, -588)
                local vardist = Distance(plr.Character.HumanoidRootPart.Position, place)
                game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart, TweenInfo.new(vardist/5000, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-15, 238, -588)}):Play()
            end

            if cht== prefix.."br5" or cht == prefix.."br5" or cht == prefix.."br5" or cht == prefix.."br5" then
                local place = Vector3.new(-15, 238, -730)
                local vardist = Distance(plr.Character.HumanoidRootPart.Position, place)
                game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart, TweenInfo.new(vardist/5000, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-15, 238, -730)}):Play()
            end

            if cht== prefix.."br6" or cht == prefix.."br6" or cht == prefix.."br6" or cht == prefix.."br6" then
                local place = Vector3.new(-15, 238, -882.5)
                local vardist = Distance(plr.Character.HumanoidRootPart.Position, place)
                game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart, TweenInfo.new(vardist/5000, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-15, 238, -882.5)}):Play()
            end

            if cht== prefix.."br7" or cht == prefix.."br7" or cht == prefix.."br7" or cht == prefix.."br7" then
                local place = Vector3.new(-15, 238, -1050)
                local vardist = Distance(plr.Character.HumanoidRootPart.Position, place)
                game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart, TweenInfo.new(vardist/5000, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-15, 238, -1050)}):Play()
            end
            ...
            if cht== prefix.."qt1" or cht == prefix.."qt1" or cht == prefix.."qt1" or cht == prefix.."qt1" then
                local place = Vector3.new(-68.6410828, 235.859634, 36.1600113)
                local vardist = Distance(plr.Character.HumanoidRootPart.Position, place)
                game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart, TweenInfo.new(vardist/5000, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-68.6410828, 235.859634, 36.1600113)}):Play()
            end

            if cht== prefix.."qt2" or cht == prefix.."qt2" or cht == prefix.."qt2" or cht == prefix.."qt2" then
                local place = Vector3.new(-68.6410828, 235.859634, 221.160004)
                local vardist = Distance(plr.Character.HumanoidRootPart.Position, place)
                game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart, TweenInfo.new(vardist/5000, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-68.6410828, 235.859634, 221.160004)}):Play()
            end

            if cht== prefix.."qt3" or cht == prefix.."qt3" or cht == prefix.."qt3" or cht == prefix.."qt3" then
                local place = Vector3.new(-68.6410828, 235.859634, 668.160034)
                local vardist = Distance(plr.Character.HumanoidRootPart.Position, place)
                game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart, TweenInfo.new(vardist/5000, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-68.6410828, 235.859634, 668.160034)}):Play()
            end

            if cht== prefix.."qt4" or cht == prefix.."qt4" or cht == prefix.."qt4" or cht == prefix.."qt4" then
                local place = Vector3.new(-68.6410828, 235.859634, 391.160004)
                local vardist = Distance(plr.Character.HumanoidRootPart.Position, place)
                game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart, TweenInfo.new(vardist/5000, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-68.6410828, 235.859634, 391.160004)}):Play()
            end

            if cht== prefix.."qt5" or cht == prefix.."qt5" or cht == prefix.."qt5" or cht == prefix.."qt5" then
                local place = Vector3.new(-68.6410828, 235.859634, 306.160004)
                local vardist = Distance(plr.Character.HumanoidRootPart.Position, place)
                game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart, TweenInfo.new(vardist/5000, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-68.6410828, 235.859634, 306.160004)}):Play()
            end

            if cht== prefix.."qt6" or cht == prefix.."qt6" or cht == prefix.."qt6" or cht == prefix.."qt6" then
                local place = Vector3.new(-68.6410828, 235.859634, 483.160004)
                local vardist = Distance(plr.Character.HumanoidRootPart.Position, place)
                game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart, TweenInfo.new(vardist/5000, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-68.6410828, 235.859634, 483.160004)}):Play()
            end

            if cht== prefix.."qt7" or cht == prefix.."qt7" or cht == prefix.."qt7" or cht == prefix.."qt7" then
                local place = Vector3.new(-68.6410828, 235.859634, 570.160034)
                local vardist = Distance(plr.Character.HumanoidRootPart.Position, place)
                game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart, TweenInfo.new(vardist/5000, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-68.6410828, 235.859634, 570.160034)}):Play()
            end

            if cht== prefix.."qt8" or cht == prefix.."qt8" or cht == prefix.."qt8" or cht == prefix.."qt8" then
                local place = Vector3.new(-68.6410828, 235.859634, 135.160004)
                local vardist = Distance(plr.Character.HumanoidRootPart.Position, place)
                game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart, TweenInfo.new(vardist/5000, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-68.6410828, 235.859634, 570.160034)}):Play()
            end

            if cht== prefix.."qht1" or cht == prefix.."qht1" or cht == prefix.."qht1" or cht == prefix.."qht1" then
                local place = Vector3.new(-9.36930752, 235.859604, 139.186035)
                local vardist = Distance(plr.Character.HumanoidRootPart.Position, place)
                game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart, TweenInfo.new(vardist/5000, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-9.36930752, 235.859604, 139.186035)}):Play()
            end

            if cht== prefix.."qht2" or cht == prefix.."qht2" or cht == prefix.."qht2" or cht == prefix.."qht2" then
                local place = Vector3.new(-9.36930752, 235.859604, 225.186035)
                local vardist = Distance(plr.Character.HumanoidRootPart.Position, place)
                game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart, TweenInfo.new(vardist/5000, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-9.36930752, 235.859604, 225.186035)}):Play()
            end

            if cht== prefix.."qht3" or cht == prefix.."qht3" or cht == prefix.."qht3" or cht == prefix.."qht3" then
                local place = Vector3.new(-13.1093254, 235.859604, 574.186035)
                local vardist = Distance(plr.Character.HumanoidRootPart.Position, place)
                game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart, TweenInfo.new(vardist/5000, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-13.1093254, 235.859604, 574.186035)}):Play()
            end

            if cht== prefix.."qht4" or cht == prefix.."qt4" or cht == prefix.."qht4" or cht == prefix.."qht4" then
                local place = Vector3.new(-9.36930752, 235.859604, 40.186039)
                local vardist = Distance(plr.Character.HumanoidRootPart.Position, place)
                game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart, TweenInfo.new(vardist/5000, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-9.36930752, 235.859604, 40.186039)}):Play()
            end

            if cht== prefix.."qht5" or cht == prefix.."qht5" or cht == prefix.."qht5" or cht == prefix.."qht5" then
                local place = Vector3.new(-9.36930752, 235.859604, 310.186035)
                local vardist = Distance(plr.Character.HumanoidRootPart.Position, place)
                game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart, TweenInfo.new(vardist/5000, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-9.36930752, 235.859604, 310.186035)}):Play()
            end

            if cht== prefix.."qht6" or cht == prefix.."qht6" or cht == prefix.."qht6" or cht == prefix.."qht6" then
                local place = Vector3.new(-9.36930752, 235.859604, 395.186035)
                local vardist = Distance(plr.Character.HumanoidRootPart.Position, place)
                game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart, TweenInfo.new(vardist/5000, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-9.36930752, 235.859604, 395.186035)}):Play()
            end

            if cht== prefix.."qt7" or cht == prefix.."qht7" or cht == prefix.."qht7" or cht == prefix.."qht7" then
                local place = Vector3.new(-9.36930752, 235.859604, 487.186035)
                local vardist = Distance(plr.Character.HumanoidRootPart.Position, place)
                game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart, TweenInfo.new(vardist/5000, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-9.36930752, 235.859604, 487.186035)}):Play()
            end

            if cht== prefix.."qht8" or cht == prefix.."qht8" or cht == prefix.."qht8" or cht == prefix.."qht8" then
                local place = Vector3.new(-9.36930752, 235.859604, 672.186035)
                local vardist = Distance(plr.Character.HumanoidRootPart.Position, place)
                game:GetService("TweenService"):Create(plr.Character.HumanoidRootPart, TweenInfo.new(vardist/5000, Enum.EasingStyle.Linear), {CFrame = CFrame.new(-9.36930752, 235.859604, 672.186035)}):Play()
            end
            ...
            game.RunService.Stepped:connect(function ()
                if plr.PlayerGui:FindFirstChild("HUD") then
                    if plr.PlayerGui.HUD.FullSize.Quests:FindFirstChild("ImageLabel") then
                        ...
                        plr.PlayerGui.HUD.FullSize.Quests.TextLabel.Text = "Galaxy CMDS UPDATE 2024 !!"
